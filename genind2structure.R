# Credits: Dr Davíð Gíslason 
# Converts genind object from adegenet to structure file 
...
genind2structure(x, file="C:/Users/alexa/Matis/structure_cor_seage", pops=TRUE)
#pops to TRUE if there is population given
